                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="block w-full pl-4 pr-10 py-3 text-gray-700 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent rounded-xl bg-gray-50 transition-all hover:bg-white"
                                >
                                    {users.map((user) => (
